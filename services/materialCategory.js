...
async function getAllMaterialCategories(req, res, next) {
...
async function getMaterialCategory(req, res, next) {
...
async function deleteMaterialCategory(req, res, next) {
  ...
  try {
    const category = await prisma.materialCategory.delete({
      where: {
        organizationId,
        id: categoryId,
      },
